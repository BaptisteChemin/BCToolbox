function [Signal_Leader_Filt,Signal_Follower_Filt,Signal_Leader_Error,Signal_Follower_Error] = BT_DataTransform_Whiten(Signal_Leader,Signal_Follower,Na)
    ...
    Signal_Leader           = Signal_Leader - mean(All_Signals);
    Signal_Follower         = Signal_Follower - mean(All_Signals);
    ...
    Signal_Leader_Filt      = Signal_Leader_Filt + mean(All_Signals);
    Signal_Follower_Filt    = Signal_Follower_Filt + mean(All_Signals);
    
    Signal_Leader_Error     = Signal_Leader_Error + mean(All_Signals);
    Signal_Follower_Error   = Signal_Follower_Error + mean(All_Signals);
